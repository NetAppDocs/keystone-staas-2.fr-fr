...
Sur la page *Abonnements*, la colonne *Keystone version* est désormais masquée par défaut, et la colonne *Linked subscriptions* n'apparaît que lorsque des linked subscriptions sont disponibles.
