...
summary: 'L"API REST de Digital Advisor récupère les détails de consommation actuels pour tous les abonnements associés à l"ID client donné.' 
---
= Obtenez les détails de consommation des clients Keystone à l'aide de l'API REST de Digital Advisor
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
