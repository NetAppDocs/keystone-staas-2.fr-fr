...
[role="lead"]
Cette API récupère une liste de tous les abonnements et niveaux de service associés au customerID donné.
...
L'API répondra avec un objet JSON contenant une liste de tous les abonnements et les détails du niveau de service associé pour le client donné.  Voici un exemple de réponse :
