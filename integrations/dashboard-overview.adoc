...
* *Surveiller les détails de l'abonnement* : Consultez des informations détaillées sur vos abonnements Keystone, notamment les niveaux de service de performance (services de base et services complémentaires tels que la protection des données et Data Infrastructure Insights), l'utilisation de la capacité, les actifs et les alertes.
...
| Oui | Oui 
 ...
 a| 
link:../integrations/adp-tab.html["Consulter la consommation et l'état de MetroCluster"]
| Oui (inclut l'état de santé, la vue topologique et la surveillance de la synchronisation) | Oui (données de consommation uniquement) 
