...
+
image:monitoring-alerts-default-view-2.png["Une capture d'écran des alertes actives pour les abonnements Keystone"]
...
TIP: Vous pouvez personnaliser le tableau à l'aide de l'icône de sélection des colonnes image:column-selector.png["icône de sélecteur de colonne"].
...
NOTE: La modification des alertes nécessite le rôle d'administrateur Keystone . Le rôle *Visionneuse Keystone * permet uniquement de consulter les détails des alertes. Pour en savoir plus, consultez link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html["Rôles d'accès Keystone dans la NetApp Console"^].
