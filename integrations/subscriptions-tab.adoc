...
+
image:console-subscription.png["afficher les détails de l'onglet abonnement"]
...
** *Abonnements liés* : Si vous avez des abonnements secondaires liés à votre abonnement principal, cette colonne affiche les numéros d’abonnement liés pour l’abonnement principal. Cette colonne est masquée par défaut et n’apparaît que lorsque des abonnements liés sont disponibles.
** *Version Keystone* : la version du service Keystone utilisée pour l’abonnement. Les règles du plan tarifaire pour les niveaux de service de performance peuvent différer selon les versions d’abonnement. Pour en savoir plus sur la version v1, consultez  https://docs.netapp.com/us-en/keystone/index.html["Services d'abonnement Keystone | Documentation de la version 1"^]. Cette colonne est masquée par défaut et peut être activée à l’aide de l’icône de sélection des colonnes image:column-selector.png["icône de sélecteur de colonne"].
...
** *Jours restants avant l'expiration de l'abonnement* : Une icône s'affiche à côté de la date d'expiration pour indiquer la proximité de l'expiration de l'abonnement et s'il sera renouvelé automatiquement. Ce statut est en lecture seule et reflète les conditions de votre contrat. Pour consulter les détails du contrat, reportez-vous à link:../integrations/subscription-timeline.html["Consultez la chronologie de vos abonnements Keystone"].
+
Lorsque le renouvellement automatique est désactivé, la couleur de l'icône indique la proximité de l'expiration :

+
*** *Vert* : Il reste plus de 120 jours avant l’expiration.
*** *Orange* : Il reste entre 91 et 120 jours avant l’expiration.
*** *Rouge* : Moins de 90 jours avant l’expiration. Pour éviter toute interruption de service, veuillez soumettre une demande de renouvellement au support NetApp Keystone.
*** *Gris* : L’abonnement a expiré.
+
Pour les abonnements avec renouvellement automatique activé, une icône de renouvellement automatique s'affiche, indiquant que l'abonnement sera renouvelé automatiquement à la fin de la période en cours.
