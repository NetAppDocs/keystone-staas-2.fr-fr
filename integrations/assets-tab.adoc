...
* Les options du menu déroulant *Affichage* dépendent de votre plateforme d'abonnement Keystone . Les *volumes en clusters* et les *nœuds en clusters* sont disponibles pour ONTAP. Pour StorageGRID, le menu déroulant *View* n'est pas disponible, le tableau *Nodes in grids* s'affiche automatiquement. Si votre abonnement inclut les deux plateformes, les trois options sont disponibles.
...
+
Vous voyez les informations détaillées sur les volumes dans les clusters, y compris le nom du volume, le numéro de série du nœud, la conformité aux politiques QoS, le nom du cluster, le nom de l'hôte et les niveaux de service de performance. Vous pouvez également surveiller la capacité provisionnée, l'utilisation logique et physique, les données froides et les données chaudes.
