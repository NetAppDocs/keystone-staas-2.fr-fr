...
| Description du problème | Après la réparation | Corrigé dans la version 
 ...
 a| 
Les abonnements affichent incorrectement le statut *Dépassement de la limite de consommation* dans le tableau de bord Digital Advisor alors que la consommation reste dans les limites de consommation autorisées.
 a| 
Fixé
 a| 
08/12/2025
